	              ...
	              <div class="row">
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select type="text" class="form-control" name="gov_id" required>
			            		<option></option>
			            		@if($gov ??'')
			            			@foreach($gov as $row)
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select type="text" class="form-control" name="package_id" required>
			            	<option></option>
			            		@if($package ??'')
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select type="text" id="unionx" class="form-control" onchange="union_function()" name="union_id" required>
			            	<option></option>
			            		@if($union ??'')
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select id="guildx" type="text" class="form-control" onchange="guild()" name="guild_id" required>
			            	<option></option>
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select type="text" id="guildsubx" class="form-control" name="guild_sub_id" required>
			            		<option></option>
			            	</select>
			            </div>
	              	</div>
	              	...
	              	<div class="col-md-3">
	              		<div class="form-group">
			            	<label for="exampleInputEmail1">سنوات العمل ضمن المهنة</label>
			            	<select type="text" class="form-control" name="work_years" required>
	              	...
	              	<div class="col-md-3">
	              		<div class="form-group">
			            	<label for="exampleInputEmail1">التصنيف المهني</label>
			            	<select type="text" class="form-control" name="categorize" required>
	              	...
	              	<div class="col-md-2">
	              		<div class="form-group">
			            	<label for="exampleInputEmail1">عنوان العمل المحافظة</label>
			            	<select type="text" class="form-control" name="job_govs" required>
			            		<option></option>
			            		@if($gov ??'')
			            			@foreach($gov as $row)
	              	...
	              	<div class="col-md-4">
	              		<div class="form-group">
			            	<label for="exampleInputEmail1">اسم جهة العمل</label>
			            	<textarea type="text" class="form-control" name="job_address"  required></textarea>
			            </div>
	              	</div>
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select type="text" class="form-control" name="card_id" required>
			            	<option></option>
			            		@if($card ??'')
			            			@foreach($card as $row)
                    ...
                    <div class="col-md-6">
	              	...
	              	<div class="col-md-12">
	              		<br><br>
	              		<h3 style="color: red;"> السجل الصحي للمنتسب</h3>
	              		<br><br>
	              	</div>
	              	...
	              	<div class="col-md-12">
	              		<div class="form-group">
			            	<label for="exampleInputEmail1">كود المسوق ان وجد</label>
