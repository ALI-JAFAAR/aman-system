              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select type="text" class="form-control" name="gov_id">
                    <option value="{{$data->gov_id}}"> {{$data->gov->name}}</option>
                    @if($gov ??'')
                      @foreach($gov as $row)
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">نسبة المبيعات</label>
                  <input type="text" class="form-control" value="{{$data->cost_persent}}" name="cost_persent" >
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">سعر المبيعات</label>
                  <input type="text" class="form-control" value="{{$data->cost}}" name="cost" >
                </div>

                <div class="form-group">
                  <label for="exampleInputFile">شعار الاتحاد</label>
                ...
                <div class="form-group">
                  <label for="exampleInputFile">توقيع رئيس الاتحاد</label>
                  <div class="input-group">
                    <div class="custom-file">
