	              ...
	              <div class="row">
	              	...
	              	<div class="col-md-6">
	              		<div class="form-group">
			            	...
			            	<select type="text" id="unionx" class="form-control" onchange="union()" name="union_id" required>
			            	<option></option>
			            		@if($union ??'')
	              	...
	              	<div class="col-md-3">
	              		<div class="form-group">
			            	...
			            	<select type="text" class="form-control" onchange="cate()" id="work_years" name="work_years" required>
	              	...
	              	<div class="col-md-3">
	              		<div class="form-group">
			            	...
			            	<select type="text" class="form-control" id="xxx" name="categorize" required>
	              	...
	              	<div class="col-md-3">
	              		<div class="form-group">
			            	...
			            	<select type="text" class="form-control" name="job_gov" required>
			            		<option></option>
			            		@if($gov ??'')
			            			@foreach($gov as $row)
			            				<option value="{{$row->id}}">{{$row->name}}</option>
...
@section('script')
	...
	<script>
        ...
        function cate(){
			var x = $('#work_years').find(":selected").val();

            $("#xxx").each(function() {
				$(this).empty();
			});
			if(x ==1 || x< 2)
				$("#xxx").append('<option value="مساعد">مساعد</option>');
			if(x ==2 || x< 3)
				$("#xxx").append('<option value="مؤهل">مؤهل</option>');
			if(x ==3 || x< 5)
				$("#xxx").append('<option value="ممارس">ممارس</option>');
			if(x ==5 || x< 10)
				$("#xxx").append('<option value="مختص">مختص</option>');
		}
