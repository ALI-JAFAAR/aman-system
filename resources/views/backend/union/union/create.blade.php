	          ...
	          <form role="form" enctype="multipart/form-data" method="post">
	            ...
	            <div class="card-body">
	              ...
	              <div class="form-group">
	                <label for="exampleInputEmail1">اسم الجهة</label>
	              ...
	              <div class="form-group">
	                ...
	                <input type="text" class="form-control" name="cost_persent" >
	              </div>
	              ...
	              <div class="form-group">
	                <label for="exampleInputFile">شعار الجهة</label>
	              ...
	              <div class="form-group">
	                <label for="exampleInputFile">توقيع رئيس الجهة</label>
	                <div class="input-group">
	                  <div class="custom-file">
